...
| Axis | Score | Detail |
|------|-------|--------|
| **AI Readiness** | **59.95 / 100** | Navigate: 91.70, Understand: 61.75, Verify: 37.50. Penalties: -5. |
...
## AI Readiness: 59.95 / 100

### Pillar 1: Navigate — 91.70 / 100 (weight: 0.35)
...
| N5 | code_consistency | **80** | 0.13 | linter=1, formatter=1, ci_enforced=0, configs=2 |
...
### Pillar 2: Understand — 61.75 / 100 (weight: 0.35)
...
| U3 | readme_substance | **20** | 0.15 | readme_lines=146, desc=1, setup=0, usage=0, arch=0, contrib=0 |
...
### Pillar 3: Verify — 37.50 / 100 (weight: 0.30)
...
| # | Signal | Score | Weight | Evidence |
|---|--------|-------|--------|----------|
| V1 | test_source_ratio | **25** | 0.30 | ratio=.160 (141 test / 880 source) |
...
Readiness_raw = Navigate × 0.35 + Understand × 0.35 + Verify × 0.30
              = 91.70 × 0.35 + 61.75 × 0.35 + 37.50 × 0.30
              = 64.95
...
| Last push | 2026-03-25T13:18:38Z |
| Tree entries | 2424 |
| Source files | 880 |
| Test files | 141 |
| Directories | 509 |
...
```
Navigate   = 91.70  (weight 0.35)
Understand = 61.75  (weight 0.35)
Verify     = 37.50  (weight 0.30)
...
### Improve AI Understanding (Understand: 61.75/100)

- **Documentation coverage (U2=25):** Add rustdoc (`///`) to public functions, types, and modules. This is the single highest-impact improvement for AI comprehension.
...
### Strengthen Verification (Verify: 37.50/100)
