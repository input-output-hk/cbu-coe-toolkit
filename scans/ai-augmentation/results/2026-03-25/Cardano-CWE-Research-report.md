# AAMM — Sample Report: input-output-hk/Cardano-CWE-Research
...
| Axis | Score | Detail |
|------|-------|--------|
| **AI Readiness** | **0 / 100** | Navigate: 16.00, Understand: 18.25, Verify: 0. Penalties: -15. |
...
### Pillar 1: Navigate — 16.00 / 100 (weight: 0.35)

**Poate AI-ul lucra eficient aici?**

| # | Signal | Score | Weight | Evidence |
|---|--------|-------|--------|----------|
| N1 | file_organization | **0** | 0.12 | max_depth=1, directories=2 |
| N2 | file_granularity | **100** | 0.13 | median_lines=0, large_files=0, per_file_penalty=-0 |
| N3 | module_boundaries | **0** | 0.15 | workspace_files=0, package_manifests=0 |
...
| N6 | cicd_pipeline | **0** | 0.15 | workflows=0, has_build=0, has_deploy=0, days_since_push=50 |
...
| # | Signal | Score | Weight | Evidence |
|---|--------|-------|--------|----------|
| U1 | type_safety | **40** | 0.30 | null — requires manual type safety assessment |
| U2 | doc_coverage | **25** | 0.25 | Not sampled — requires agent file content analysis. Override recommended. |
| U3 | readme_substance | **0** | 0.15 | readme_lines=5, desc=0, setup=0, usage=0, arch=0, contrib=0 |
...
| Field | Value |
|-------|-------|
| Repository | `input-output-hk/Cardano-CWE-Research` |
| Description | Research repository for the Plu-stan analyzer |
| Default branch | `main` |
| Private | false |
| Primary language | null (null%) |
| Languages |  |
| Size | 174 KB |
| Open issues | 0 |
| Stars | 0 |
| License | Apache-2.0 |
| Created | 2025-11-03T11:29:42Z |
| Last push | 2026-02-02T19:59:49Z |
| Tree entries | 33 |
| Source files | 0 |
| Test files | 0 |
| Directories | 2 |
