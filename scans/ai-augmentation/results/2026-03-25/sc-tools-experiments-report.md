# AAMM — Sample Report: input-output-hk/sc-tools-experiments
...
| Axis | Score | Detail |
|------|-------|--------|
| **AI Readiness** | **63.07 / 100** | Navigate: 79.85, Understand: 45.25, Verify: 81.00. Penalties: -5. |
...
```
         ...
         High │ ★ FERTILE   │  AI-NATIVE  │
              │   GROUND    │             │
AI Readiness  │ (sc-tools-experiments)  │              │
    ↑         │             │              │
              ├─────────────┼─────────────┤
              │             │  RISKY      │
...
## AI Readiness: 63.07 / 100

### Pillar 1: Navigate — 79.85 / 100 (weight: 0.35)

**Poate AI-ul lucra eficient aici?**

| # | Signal | Score | Weight | Evidence |
|---|--------|-------|--------|----------|
| N1 | file_organization | **75** | 0.12 | max_depth=6, directories=20 |
| N2 | file_granularity | **100** | 0.13 | median_lines=129, large_files=0, per_file_penalty=-0 |
...
| U3 | readme_substance | **60** | 0.15 | readme_lines=165, desc=1, setup=1, usage=0, arch=0, contrib=1 |
...
### Pillar 3: Verify — 81.00 / 100 (weight: 0.30)

**Poate AI-ul verifica ce produce?**

**Hard Gate:** PASS (25 test files)

| # | Signal | Score | Weight | Evidence |
|---|--------|-------|--------|----------|
| V1 | test_source_ratio | **100** | 0.30 | ratio=1.190 (25 test / 21 source) |
...
Readiness_raw = Navigate × 0.35 + Understand × 0.35 + Verify × 0.30
              = 79.85 × 0.35 + 45.25 × 0.35 + 81.00 × 0.30
              = 68.07
...
| Field | Value |
|-------|-------|
| Repository | `input-output-hk/sc-tools-experiments` |
| Description |  Select coins, build transactions |
| Default branch | `main` |
| Private | false |
| Primary language | Haskell (92.2%) |
| Languages | Haskell: 92.2%,Aiken: 6.4%,Nix: 1.2%,Shell: 0.2% |
| Size | 2315 KB |
| Open issues | 4 |
| Stars | 0 |
| License | Apache-2.0 |
| Created | 2025-11-25T14:14:36Z |
| Last push | 2026-03-24T15:17:54Z |
| Tree entries | 115 |
| Source files | 21 |
| Test files | 25 |
| Directories | 20 |
...
```
Navigate   = 79.85  (weight 0.35)
Understand = 45.25  (weight 0.35)
Verify     = 81.00  (weight 0.30)
