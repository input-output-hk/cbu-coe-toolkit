# AAMM — Sample Report: input-output-hk/sc-fvt
...
| Axis | Score | Detail |
|------|-------|--------|
| **AI Readiness** | **19.96 / 100** | Navigate: 58.10, Understand: 21.25, Verify: 24.00. Penalties: -15. |
...
|---|--------|-------|--------|----------|
| N1 | file_organization | **100** | 0.12 | max_depth=8, directories=60 |
...
### Pillar 2: Understand — 21.25 / 100 (weight: 0.35)
...
| U3 | readme_substance | **20** | 0.15 | readme_lines=54, desc=1, setup=0, usage=0, arch=0, contrib=0 |
...
Readiness_raw = Navigate × 0.35 + Understand × 0.35 + Verify × 0.30
              = 58.10 × 0.35 + 21.25 × 0.35 + 24.00 × 0.30
              = 34.96
...
| **Delivery** | None | 0 | ✓ build_workflow=true, issues=true (open=231) | ✗ no AI config with Delivery category | Practice active, no AI config |
...
| Field | Value |
|-------|-------|
| Repository | `input-output-hk/sc-fvt` |
| Description | N/A |
| Default branch | `main` |
| Private | true |
| Primary language | Lean (99.5%) |
| Languages | Lean: 99.5%,Makefile: 0.4%,Shell: 0.1% |
| Size | 16644 KB |
| Open issues | 231 |
| Stars | 4 |
| License | Unknown |
| Created | 2024-04-23T11:46:19Z |
| Last push | 2026-03-25T04:24:38Z |
| Tree entries | 266 |
| Source files | 0 |
| Test files | 0 |
| Directories | 60 |
...
### Improve AI Understanding (Understand: 21.25/100)
