...
| Axis | Score | Detail |
|------|-------|--------|
| **AI Readiness** | **62.29 / 100** | Navigate: 94.95, Understand: 46.75, Verify: 59.00. Penalties: -5. |
...
| N6 | cicd_pipeline | **75** | 0.15 | workflows=16, has_build=1, has_deploy=0, days_since_push=0 |
...
Readiness_raw = Navigate × 0.35 + Understand × 0.35 + Verify × 0.30
              = 94.95 × 0.35 + 46.75 × 0.35 + 59.00 × 0.30
              = 67.29
...
| Last push | 2026-03-25T13:13:06Z |
| Tree entries | 1527 |
| Source files | 399 |
| Test files | 100 |
| Directories | 355 |
